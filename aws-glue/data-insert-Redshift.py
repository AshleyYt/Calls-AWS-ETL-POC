...
datasink = glueContext.write_dynamic_frame.from_jdbc_conf(frame = mapped_df, catalog_connection = "xxxxxxx", connection_options = {"dbtable": "external_data_schema.xxxxxx", "database": "dev"}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink")
